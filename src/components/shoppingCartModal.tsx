    ...
    return (
      <Sheet open={shouldDisplayCart} onOpenChange={() => handleCartClick()}>
        <SheetContent className="sm:max-w-lg w-[100vw] dark:bg-gray-900 dark:text-gray-100">
          <SheetHeader>
            <SheetTitle className="flex items-center justify-center h-full text-3xl text-black dark:text-blue-400 hover:text-blue-600 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white border-b pb-2 border-gray-200 dark:border-gray-700 font-bold">
              CART
            </SheetTitle>
          </SheetHeader>
